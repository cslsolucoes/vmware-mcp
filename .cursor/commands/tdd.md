...
o agente `developer-delphi-agent-tester` cria os testes da nova classe automaticamente e notifica
o usuario com a lista dos casos criados.

Use o agente `developer-delphi-agent-tester` para executar a analise e geracao.
Carregue a skill `developer-delphi-testing-dunitx` e os padroes em `references/dunitx-patterns.md`.
